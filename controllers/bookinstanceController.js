...
exports.bookinstance_detail = function(req, res, next){
  ...
  BookInstance.findById(req.params.id)
    ...
    .exec(function (err, bookinstance) {
      ...
      // Successful, so render.
      res.render('bookinstance_detail.ejs', { title: 'Copy: '+bookinstance.book.title, bookinstance:  bookinstance
      });
...
exports.bookinstance_create_get = function(req, res, next) {       
  ...
  .exec(function (err, books) {
    if (err) { return next(err); }
    // Successful, so render.
    res.render('bookinstance_form.ejs', {title: 'Create Book Instance', books: books});
  });
  ...
  (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      ...
      Book.find({},'title').exec(function (err, books)
      {
        if (err) { return next(err); }
        // Successful, so render.
        res.render('bookinstance_form.ejs', { title: 'Create Book Instance', books: books, selected_book: bookinstance.book._id , errors: errors.array(), bookinstance: bookinstance });
      });
      return;
    }
    else {
...
exports.bookinstance_delete_get = function(req, res, next) {
  ...
  async.parallel({
      ...
      // Successful, so render.
      res.render('bookinstance_delete.ejs', { title: 'Delete Bookinstance', bookinstance: results.bookinstance } );
    }
  );
...
exports.bookinstance_update_get = function(req, res, next) 
{
  ...
  async.parallel(
    ...
    function(err, results) {
      ...
      res.render('bookinstance_form.ejs', { title: 'Update Bookinstance', bookinstance: results.bookinstance, books: results.books });
    }
  );
  ...
  (req, res, next) => {
      ...
      if (!errors.isEmpty()) {
          ...
          async.parallel({
              ...
              res.render('bookinstance_form.ejs', { title: 'Update Bookinstance', books: books, errors: errors.array() });
          });
          return;
      }
      else {
