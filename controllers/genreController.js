...
exports.genre_list = function(req, res) {
    ...
    Genre.find().sort([['name', 'ascending']]).exec( (err, genreList ) => {
			...
			res.render('genre_list.ejs', {title: 'Genre List', genre_list: genreList });
...
exports.genre_detail = function(req, res, next) {
	...
	async.parallel({
		...
		function(err, results) {
			...
			res.render('genre_detail.ejs', {  genre: results.genre, genre_books: results.genre_books } );
		}
	);
...
exports.genre_create_get = function(req, res, next) { 
	...
	res.render('genre_form.ejs', { title: 'Create Genre' }); 
...
exports.genre_create_post =  [
  ...
  (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      ...
      res.render('genre_form.ejs', { title: 'Create Genre', genre: genre, errors: errors.array()});
      return;
    }
    else {
...
exports.genre_delete_get = function(req, res, next){
	...
	function(err, results) {
		...
		// Successful, so render.
		res.render('genre_delete.ejs', { title: 'Delete Genre', genre: results.genre, genres_books: results.genres_books } );
	});
	console.log('genreController.js exports.genre_delete_get');
...
exports.genre_update_get = function(req, res, next) 
{
  ...
  async.parallel(
    ...
    function(err, results) {
      ...
      res.render('genre_form.ejs', { title: 'Update Genre', genre: results.genre });
    }
  );
...
exports.genre_update_post = [
	...
	(req, res, next) => {
		...
		if (!errors.isEmpty()) {
			...
			res.render('genre_form.ejs', { title: 'Update Genre', genre: req.body, errors: errors.array() });
