...
exports.book_list = function(req, res, next) {
    ...
    Book.find({}, 'title author')
      ...
      .exec(function (err, listOfBooks) {
        ...
        res.render('book_list.ejs', { title: 'Book List', book_list: listOfBooks });
        console.log('bookController.js exports.book_list Book.exec');
...
exports.book_create_get = function(req, res, next) { 
    ...
    let authors2 = Array.from(Object.create(results.authors))
		...
		res.render('book_form.ejs', { title: 'Create Book', authors: results.authors, genres: results.genres });
	});
	console.log('bookController.js exports.book_create_get  (req,res,next)');
	...
	(req, res, next) => {
		...
		if (!errors.isEmpty()) {
			...
			function(err, results) {
				...
				res.render('book_form.ejs', { title: 'Create Book',authors:results.authors, genres:results.genres, book: book, errors: errors.array() });
			});
			return;
		}
		else {
...
exports.book_delete_get = function(req, res, next){
  ...
  function(err, results) {
    ...
    // Successful, so render.
    res.render('book_delete.ejs', { title: 'Delete book', book: results.book, book_bookinstances: results.book_bookinstances } );
  });
  console.log('bookController.js exports.book_delete_get');
...
exports.book_update_get = function(req, res, next) {
	...
	async.parallel({
		...
		function(err, results) {
			...
			res.render('book_form.ejs', { title: 'Update Book', authors: results.authors, genres: results.genres, book: results.book });
		}
	);
