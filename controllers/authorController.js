...
exports.author_list = function(req, res, next) {
	...
	.exec(function (err, authorList) {
		...
		res.render('author_list.ejs', { title: 'Author List', author_list: authorList 
		});
...
// };
// Display detail page for a specific Author.
// see async.parallel({ author: fn(){}, authors_books: fn(){} }, fn(err,results){...res.render(page)}) => results=[ author, authors_books]
exports.author_detail = function(req, res, next) {
	...
	async.parallel( 
		...
		function(err, results) {
			...
			// Successful, so render.
			res.render('author_detail.ejs', { title: 'Author Detail', author: results.author, author_books: results.authors_books });
...
exports.author_create_get = function(req, res, next) {
	...
	res.render('author_form.ejs', { title: 'Create Author'}); 
...
exports.author_create_post = [
	...
	(req, res, next) => {
		...
		if (!errors.isEmpty()) {
			...
			res.render('author_form.ejs', { title: 'Create Author', author: req.body, errors: errors.array() });
			return;
		}
		else {
...
exports.author_delete_get = function(req, res, next) {
	...
	function(err, results) {
		...
		// Successful, so render.
		res.render('author_delete.ejs', { title: 'Delete Author', author: results.author, author_books: results.authors_books } );
	});
	console.log('authorController.js exports.author_delete_get');
...
exports.author_update_get = function(req, res, next) 
{
  ...
  async.parallel(
    ...
    function(err, results) {
      ...
      res.render('author_form.ejs', { title: 'Update author', author: results.author });
    }
  );
  ...
  (req, res, next) => {
		...
		if (!errors.isEmpty()) {
				...
				//     if (err) { return next(err); }
						...
						//    }
						//}
						res.render('author_form.ejs', { title: 'Update author', author: req.body, errors: errors.array() });
